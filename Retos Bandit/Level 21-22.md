...
```shell
C:\Users\Marco De Avila>ssh bandit21@bandit.labs.overthewire.org -p 2220
                         _                     _ _ _
                        | |__   __ _ _ __   __| (_) |_
                        | '_ \ / _` | '_ \ / _` | | __|
                        | |_) | (_| | | | | (_| | | |_
...
**Password encontrado: ** WdDozAdTM2z9DiFEQ2mGlwngMfj4EZff
## Notas adicionales

|Termino | Descripción |
|-|-|
|Cron | es un proceso en segundo plano de Linux que es ejecutado una vez se inicia el sistema operativo y que se encarga de comprobar la existencia de algún proceso, tarea o guiones a ejecutar en una hora determinada.|
## Referencias

[¿Cómo usar Cron y Crontab en Linux? (keepcoding.io)](https://keepcoding.io/blog/como-usar-cron-y-crontab-en-linux/)